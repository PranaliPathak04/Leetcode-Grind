export const roadmap = [
  {
    ...
    tagColor: "#22c55e",
    watchFirst:
      "Arrays Introduction, 2D Arrays, ArrayList, HashMap & HashSet lectures",
    context:
      "Arrays & Hashing is where most easy problems live. Don't skip any — these show up in every company OA.",
    problems: [
      {
        id: "ah-1",
  ...
  },
  {
    ...
    context:
      "Two pointers is asked in almost every company. 3Sum and Trapping Rain Water are must-knows.",
    problems: [
      {
        id: "tp-1",
  ...
  },
  {
    ...
    context:
      "Min Window Substring is hard but asked by Razorpay, Flipkart, Amazon — don't skip it.",
    problems: [
      {
        id: "sw-1",
  ...
  },
  {
    ...
    context:
      "Largest Rectangle in Histogram and Median of Two Sorted Arrays are hard but come up at Atlassian, Google.",
    problems: [
      {
        id: "sbs-1",
  ...
  },
  {
    ...
    context:
      "LRU Cache = HashMap + Doubly Linked List combined — very common interview question.",
    problems: [
      {
        id: "ll-1",
  ...
  },
  {
    ...
    tagColor: "#10b981",
    watchFirst:
      "Binary Tree intro, BST, Tree traversals, Level order traversal",
    context:
      "Trees are the #1 most asked topic in Indian product companies. Spend extra time here — it pays off most.",
    problems: [
      {
        id: "tr-1",
  ...
  },
  {
    ...
    context:
      "Design Twitter combines heap + hashtable — great project-level thinking question, often asked at startups.",
    problems: [
      {
        id: "ht-1",
  ...
  },
  {
    ...
    context:
      "Number of Islands + Course Schedule are asked in literally every company. Must-solve.",
    problems: [
      {
        id: "gr-1",
  ...
  },
  {
    ...
    context:
      "Climbing Stairs through Coin Change are the 'easy DP' problems every company asks. Nail those first.",
    problems: [
      {
        id: "dp-1",
    ...
    days: [
      ...
      },
      {
        ...
        problems: [
          ...
          {
            id: "sap-19",
            name: "Fibonacci Number (recursive + memoized)",
            difficulty: "Easy",
            leetcodeUrl: "https://leetcode.com/problems/fibonacci-number/",
          },
          {
            id: "sap-20",
            name: "Power of a Number (fast exponentiation)",
            difficulty: "Medium",
